            ...
            for (const obj of Object.getOwnPropertySymbols(components[cpn.CollisionTag.name])) {
                ...
                if (ball != obj) {
                    if (collision(components, ball, obj)) {
                        ...
                        if(axe == 'X')
                        {
                            components.VelocityComponent[ball].dx = -components.VelocityComponent[ball].dx*1.05;
                        }
                        else
                        {
                            components.VelocityComponent[ball].dy = -components.VelocityComponent[ball].dy*1.05 ;
                        }
...
export { collisionSystem, collision }